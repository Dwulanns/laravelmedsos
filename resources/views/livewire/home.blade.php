  ...
  <main class="grid lg:grid-cols-12 gap-8 md:mt-10 ">
    ...
    <aside class="lg:col-span-4   hidden lg:block p-4">
      ...
      <div class="flex items-center gap-2">
        ...
        <x-avatar wire:ignore src="https://i.pinimg.com/474x/9f/89/80/9f8980c3caa722997228bb7349e6d5c6.jpg" class="w-12 h-12" />
        <h4 class="font-medium" wire:ignore>wulan</h4>
        ...
        <ul class="my-2 space-y-3">
          ...
          <li class="flex items-center gap-3">
            <a  href="{{route('profile.home',$user->username)}}" >
              <x-avatar wire:ignore src="https://i.pinimg.com/474x/9f/89/80/9f8980c3caa722997228bb7349e6d5c6.jpg" class="w-12 h-12" />
              {{-- <x-avatar wire:ignore src="https://i.pinimg.com/564x/92/a4/b6/92a4b6f31363a3b89f4986169c2b630c.jpg{{$key}}" class="w-12 h-12" /> --}}
            </a>
