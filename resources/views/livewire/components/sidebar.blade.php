    ...
    <ul class="space-y-4 mt-2">
        ...
        <li>
            <a wire:navigate href="{{route('profile.home',auth()->user()->username)}}" class="flex items-center gap-5">
                ...
                <x-avatar src="https://i.pinimg.com/474x/9f/89/80/9f8980c3caa722997228bb7349e6d5c6.jpg" class=" w-7 h-7 shrink-0" />
                        ...
                        <li>
                            ...
                            <a href="{{route('profile.home',$user->username)}}"
                                ...
                                {{-- <x-avatar wire:ignore class="w-9 h-9 mb-auto"
                                    ...
                                    src="https://i.pinimg.com/474x/17/71/45/177145a7fac3af9ad02606fc75b50f16.jpg" />
